...
class SearchServer {
public:
    //Шаблонный конструктор может принимать коллекцию стоп-слов, находящихся в разных коллекциях — в нашем случае, в vector и set:
    ...
    //параметризованный конструктор, который принимает строку со стоп-словами
